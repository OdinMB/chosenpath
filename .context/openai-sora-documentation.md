...
Generate videos using OpenAI's Sora video generation API.
...
| `model` | string | Optional | The video generation model to use. Defaults to `sora-2` |
| `seconds` | string | Optional | Clip duration in seconds. Defaults to 4 seconds |
| `size` | string | Optional | Output resolution formatted as width x height. Defaults to `720x1280` |
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `video_id` | string | Required | The identifier of the completed video to remix |
...
List all videos for the organization.

#### Query Parameters

| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `after` | string | Optional | Identifier for the last item from the previous pagination request |
| `limit` | integer | Optional | Number of items to retrieve |
| `order` | string | Optional | Sort order of results by timestamp. Use `asc` for ascending or `desc` for descending |
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `video_id` | string | Required | The identifier of the video to retrieve |
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `video_id` | string | Required | The identifier of the video to delete |
...
Download the actual video file content.

#### Path Parameters

| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `video_id` | string | Required | The identifier of the video whose media to download |

#### Query Parameters

| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `variant` | string | Optional | Which downloadable asset to return. Defaults to the MP4 video |
...
#### Example: Poll the Status Endpoint
...
### Example Remix Results

| Original Video | Remix Generated Video |
|----------------|----------------------|
| (original) | Prompt: "Change the color of the monster to orange." |
| (original) | Prompt: "A second monster comes out right after." |
