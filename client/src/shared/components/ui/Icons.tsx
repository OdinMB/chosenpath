...
export const Icons = {
  ...
  Globe: ({ className = "w-4 h-4" }: IconProps) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-1.95.7-3.74 1.87-5.13L9 10v1c0 1.1.9 2 2 2v2H9v3.13c-2.5-1.33-5-4.08-5-6.13zm11.5 7.28c-.76.17-1.57.28-2.4.28-1.19 0-2.31-.22-3.35-.62L12 17l1.1-2h3.63c.57 0 1.1.17 1.55.45l1.43 1.43c-.17.82-.47 1.58-.87 2.28L18 20c-.59.59-1.59 0-1.59 0-.25-.25-.15-.54-.15-.72.05-.71.62-1.13.62-1.13.11-.11.13-.27.03-.4-.34-.4-.67-.82-.97-1.25-.04-.06-.08-.12-.1-.19-.06-.16-.16-.33-.05-.5.11-.17.31-.18.49-.11l.34.13c.27.1.52.25.72.44.18-.15.38-.29.58-.4.18-.1.39-.2.26-.45-.12-.23-.42-.23-.51-.42-.09-.19.22-.35.22-.35.25-.15.51-.26.78-.35-.32-.4-.49-.89-.49-1.42 0-1.25 1.01-2.25 2.25-2.25 1.06 0 1.93.85 2.06 2 .12-.05.2-.18.2-.34 0-.25-.09-.44-.19-.62.47-.75 1.1-1.38 1.87-1.9-.17-.07-.32-.15-.42-.25-.32-.3-.67-.31-.67-.31-.31-.32-.32-.52-.76-.54-1.25l2.81 2.81c.95 1.27 1.52 2.86 1.52 4.58 0 2.46-1.12 4.61-2.86 6.07-.99-1.08-2.28-1.61-2.28-1.61-.19-.13-.34.11-.34.11z" />
    </svg>
  ),
