...
export const IMAGE_GENERATION_STORY_PLAYER_QUALITY = IMAGE_QUALITIES.LOW;
export const IMAGE_GENERATION_STORY_ELEMENT_QUALITY = IMAGE_QUALITIES.LOW;
export const IMAGE_GENERATION_BEAT_QUALITY = IMAGE_QUALITIES.LOW;
